...
# dependency .debs from /prebuilt, then builds pairs_rviz_plugins and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_rviz_plugins/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_rviz_plugins
