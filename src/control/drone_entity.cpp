...
DroneEntity::DroneEntity(const std::string &name_) {
  ...
  status_subscriber          = nh.subscribe("pairs_uav_status/uav_status", 1, &DroneEntity::statusCallback, this, ros::TransportHints().tcpNoDelay());
  custom_services_subsrciber = nh.subscribe("pairs_uav_status/set_trigger_service", 5, &DroneEntity::newSeviceCallback, this, ros::TransportHints().tcpNoDelay());
  ...
  // | ------------------------ Services ------------------------ |
  service_goto_reference  = pairs_lib::ServiceClientHandler<pairs_msgs::ReferenceStampedSrv>(nh, "control_manager/reference");
  service_land            = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh, "uav_manager/land");
  service_land_home       = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh, "uav_manager/land_home");
  service_takeoff         = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh, "uav_manager/takeoff");
  service_set_constraints = pairs_lib::ServiceClientHandler<pairs_msgs::String>(nh, "constraint_manager/set_constraints");
  service_set_gains       = pairs_lib::ServiceClientHandler<pairs_msgs::String>(nh, "gain_manager/set_gains");
  service_set_controller  = pairs_lib::ServiceClientHandler<pairs_msgs::String>(nh, "control_manager/switch_controller");
  service_set_tracker     = pairs_lib::ServiceClientHandler<pairs_msgs::String>(nh, "control_manager/switch_tracker");
  service_set_estimator   = pairs_lib::ServiceClientHandler<pairs_msgs::String>(nh, "estimation_manager/change_estimator");
...
void DroneEntity::statusCallback(const pairs_msgs::UavStatusConstPtr &msg) {
  bool updated = false;
...
void DroneEntity::newSeviceCallback(const std_msgs::StringConstPtr &msg) {
  ...
  custom_services.push_back(pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh, service_address));
...
void DroneEntity::positionCmdCallback(const pairs_msgs::HwApiPositionCmdConstPtr &msg) {
  last_position = *msg;
}
...
bool DroneEntity::flyForward(bool global_mode_on) {
  pairs_msgs::ReferenceStampedSrv reference;
  if (global_mode_on) {
