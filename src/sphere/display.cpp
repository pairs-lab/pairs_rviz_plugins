...
#include <pairs_rviz_plugins/sphere/display.h>
...
namespace pairs_rviz_plugins
{
  namespace sphere
  {
    ...
    void Display::processMessage(pairs_msgs::msg::Sphere::ConstSharedPtr msg)
    {
...
PLUGINLIB_EXPORT_CLASS(pairs_rviz_plugins::sphere::Display,
                       rviz_common::Display)
