...
#ifndef PAIRS_BUMPER_DISPLAY_H
#define PAIRS_BUMPER_DISPLAY_H

#ifndef Q_MOC_RUN
#include <rviz/message_filter_display.h>
#include <pairs_msgs/Sphere.h>
#endif
...
namespace pairs_rviz_plugins
{
  ...
  namespace sphere
  {
    ...
    class Display : public rviz::MessageFilterDisplay<pairs_msgs::Sphere>
    {
      Q_OBJECT
    public:
    ...
    private:
      void processMessage(const pairs_msgs::Sphere::ConstPtr& msg);
