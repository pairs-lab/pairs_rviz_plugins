...
#include <pairs_msgs/Track.h>
#include <pairs_msgs/TrackArrayStamped.h>
...
namespace track_array
{
    ...
    class Display : public rviz::MessageFilterDisplay<pairs_msgs::TrackArrayStamped> {
        Q_OBJECT
    public:
    ...
    private:
        ...
        virtual void processMessage(const pairs_msgs::TrackArrayStamped::ConstPtr& message);
