...
#include <pairs_msgs/UavStatus.h>
...
protected:
  ...
  // | --------------------- State Callbacks -------------------- |
  void statusCallback(const pairs_msgs::UavStatusConstPtr& msg);
  void newSeviceCallback(const std_msgs::StringConstPtr& msg);
  void positionCmdCallback(const pairs_msgs::HwApiPositionCmdConstPtr& msg);

  // | ------------------------ Services ------------------------ |
  pairs_lib::ServiceClientHandler<pairs_msgs::ReferenceStampedSrv>  service_goto_reference;
  pairs_lib::ServiceClientHandler<std_srvs::Trigger>              service_land;
  pairs_lib::ServiceClientHandler<std_srvs::Trigger>              service_land_home;
  pairs_lib::ServiceClientHandler<std_srvs::Trigger>              service_takeoff;
  pairs_lib::ServiceClientHandler<pairs_msgs::String>               service_set_constraints;
  pairs_lib::ServiceClientHandler<pairs_msgs::String>               service_set_gains;
  pairs_lib::ServiceClientHandler<pairs_msgs::String>               service_set_controller;
  pairs_lib::ServiceClientHandler<pairs_msgs::String>               service_set_tracker;
  pairs_lib::ServiceClientHandler<pairs_msgs::String>               service_set_estimator;
  std::vector<pairs_lib::ServiceClientHandler<std_srvs::Trigger>> custom_services;
  ...
  std::vector<std::string>
      odom_estimators{};  // Seems to be the same as odom source
                           // (https://github.com/ctu-pairs/pairs_uav_status/blob/78f9ee8fce216a810d15d14d7a4e479e2c41d503/src/status.cpp#L872C65-L872C65)
  ...
  pairs_msgs::HwApiPositionCmd last_position;
