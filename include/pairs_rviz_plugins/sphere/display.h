...
#ifndef PAIRS_RVIZ_PLUGINS_SHPERE_DISPLAY_H
#define PAIRS_RVIZ_PLUGINS_SHPERE_DISPLAY_H

#include <pairs_rviz_plugins/sphere/visual.h>
#include <memory>
#include <pairs_msgs/msg/sphere.hpp>
...
namespace pairs_rviz_plugins
{
  namespace sphere
  {
    class Display : public rviz_common::MessageFilterDisplay<pairs_msgs::msg::Sphere>
    {
      Q_OBJECT
    public:
    ...
    protected:
      ...
      void processMessage(pairs_msgs::msg::Sphere::ConstSharedPtr msg) override;
...
}  // end namespace pairs_rviz_plugins
