...
#ifndef PAIRS_BUMPER_VISUAL_H
#define PAIRS_BUMPER_VISUAL_H
...
namespace pairs_rviz_plugins
{
  ...
  namespace bumper
  {
    ...
    public:
      ...
      using msg_t = pairs_msgs::ObstacleSectors;
    ...
    public:
      ...
      // parameters and therefore don't come from the PAIRS_Bumper_ message.
    ...
    private:
      ...
      // the PAIRS_Bumper_ message header.
